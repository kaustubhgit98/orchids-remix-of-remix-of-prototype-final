...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 border-r border-border/50 bg-card/30 backdrop-blur-xl hidden lg:flex flex-col h-screen sticky top-0">
      <div className="h-14 px-5 flex items-center border-b border-border/50">
        <Link href="/dashboard" className="flex items-center gap-2.5 group">
          <div className="w-8 h-8 rounded-lg bg-foreground flex items-center justify-center shadow-sm group-hover:shadow-md transition-all">
